=begin
  ...
  Exportation des sous-titres de l'animation définie en paramètres

  Le script lit le code de l'animation et en tire tous les sous-titres.
...
$ref = File.open(anim.path_sous_titres, 'wb')
...
# Pour me permettre d'écrire
File.chmod(0770, anim.path_sous_titres)
