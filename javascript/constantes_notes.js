...
/**
  * Données du cycle des dièses
  * Notes
  *   * C'est un {Array}, constitué d'éléments qui sont chacun les données de la dièse
  *     Quand on a une armure avec x dièses, il suffit de prendre les éléments jusqu'à ce
  *     x. On peut aussi boucle jusqu'à obtenir la tonalité cherchée
  * @class CYCLES_DIESES
  * @for window
  * @static
  * @final
...
/**
  ...
  */
window.DATA_TUNES = {
  'g' : {cycle:'dieses', nombre:1},
  'd' : {cycle:'dieses', nombre:2},
  'a' : {cycle:'dieses', nombre:3},
  'e' : {cycle:'dieses', nombre:4},
  'b' : {cycle:'dieses', nombre:5},
  'fd': {cycle:'dieses', nombre:6},
  'cd': {cycle:'dieses', nombre:7},
  'f' : {cycle:'bemols', nombre:1},
  'bb': {cycle:'bemols', nombre:2},
  'eb': {cycle:'bemols', nombre:3},
  'ab': {cycle:'bemols', nombre:4},
  'db': {cycle:'bemols', nombre:5},
  'gb': {cycle:'bemols', nombre:6},
  'cb': {cycle:'bemols', nombre:7}
}