...
// Chargement des librairies générales
  ...
  $libs = array(
    ...
    'optional'  => array('ajax_php', 'couleur', 'Edit', 'flash', 'horloge', 'jQueryRotateCompressed', 'KeyEvent_constants', 'L', 'mouse', 'Number', 'selection', 'String-extensions', 'texte', 'time', 'ui_basic', 'utils')
